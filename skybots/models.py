...
class AllMessage(models.Model):
    ...
    message_caption = models.CharField(max_length=255, null=True, verbose_name="Подпись под контент")
    message_photos = models.FileField(upload_to=get_upload_path, blank=True, null=True)
    message_value = models.TextField(blank=True, null=True, verbose_name="Контент сообщения")
...
class Lessons(models.Model):
    ...
    lessons_name = models.CharField(max_length=256, verbose_name="Название урока", unique=True)
