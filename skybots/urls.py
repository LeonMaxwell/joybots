...
urlpatterns = [
    ...
    path('<str:name_parts>/<int:pk>/editvocabulary/', views.vocabularyEdit, name="vocabularyEdit"),
    ...
    path('<str:name_parts>/<int:pk>/editbuttons/', views.buttonsEdit, name="buttonsEdit"),
    ...
    path('<str:name_parts>/<int:pk>/deletevocabulary/', views.vocabularyDelete, name="vocabularyDelete"),
    ...
    path('<str:name_parts>/<int:pk>/deletelebuttons/', views.buttonsDelete, name="buttonsDelete"),
    ...
    path('<str:name_parts>/add/doneVacul', views.VocabularyCreated, name="vocabularyCreated"),
    ...
    path('<str:name_parts>/add/donebuttons', views.buttonsCreated, name="buttonsCreated"),
]
